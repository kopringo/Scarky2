...
urlpatterns = patterns('',
    ...
    url(r'^signup$', 'account.views.signup', name='scarky_signup'),
    url(r'^confirm/(?P<login>\w+)/(?P<code>\w+)$', 'account.views.signup_confirm', name='scarky_confirm'),
    url(r'^login$', 'django.contrib.auth.views.login', {'template_name': 'account/login.html'}, name='scarky_login'),
    url(r'^logout$', 'django.contrib.auth.views.logout', {'next_page': '/'}, name='scarky_logout'),
